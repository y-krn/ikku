...
class BracketState:
    ...
    def __init__(self):
        self.__stack = []
        self.__brackets_index = {v: True for v in list(
            itertools.chain.from_iterable(self.BRACKETS_TABLE.items()))}
        self.__inverted_brackets_table = {
            v: k for k, v in self.BRACKETS_TABLE.items()}
